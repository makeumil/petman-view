		...
		<>
            ...
            <form>
                ...
                <div class={styles.form__wrap}>
                        ...
                        <input className={ reg.dogname.length > 0 ? styles.input__ok :  styles.input__nok} type='text' id='dogname' name='dogname' placeholder='분양할 아이의 이름을 입력해 주세요' onChange={onChangeValue} required></input>
                        <fieldset>
